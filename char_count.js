...
// URL within the reduce function, extract the text, and, within the logic of the reduce function,
...
// streaming/piping methods to break down the script into a managable workflow. The first function would gather
// all URLs and write them into a file that holds them all. That data would then be piped into the above
// reduce function, which would yield the end result of character tallies without causing someone's computer
// to explode.